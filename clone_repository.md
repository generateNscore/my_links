...
. 빈 VScode workspace에서 조합-키 Ctrl + `` ` `` 을 눌러 터미널(terminal)을 연다. 억음부호 (백틱, back quote) `` ` ``은 일반적인 따옴표가 아니라, 키보드(windows용) 왼쪽 상단에 위치한 숫자 1 키 왼쪽에 놓여있다 (내 경우) ![1st terminal](./img/terminal_1.jpg)
